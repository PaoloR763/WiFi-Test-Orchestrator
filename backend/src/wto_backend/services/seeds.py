...
from wto_backend.domain.models import Permission, Role, RolePermission
...
ROLES = {
    "administrator": ("Administrator", "Full explicit human administration permissions."),
...
ROLE_PERMISSIONS = {
    ...
    "test_manager": {"users.read", "roles.read", "permissions.read", "audit.read"},
    "operator": {"roles.read", "permissions.read"},
    "viewer": {"roles.read", "permissions.read"},
}
